...
const AccountDeletionConfirmation = ({
  ...
  const [selectedConfirmCheckbox, setSelectedConfirmCheckbox] = useState(false);
  const [deleteInput, setDeleteInput] = useState("");
  const requiredInput = "DELETE";
  const isButtonDisabled =
    deleteInput !== requiredInput || !selectedConfirmCheckbox;
        ...
        <form className="mt-6">
          <fieldset className="flex items-end">
            <input
              ...
              checked={selectedConfirmCheckbox}
              onChange={(event) =>
                setSelectedConfirmCheckbox(event.target.checked)
              }
            />
          ...
          <fieldset className="flex items-end">
            <input
              ...
              checked={requestData}
              onChange={(event) => setRequestData(event.target.checked)}
            />
            <label
