...
export default function YourCampaignRejected({your_campaign_rejected_activities}) {
    const [profilePicture, setProfilePicture] = useState("");
  const user_current = useSelector((state) => state.user);
  let latest_model_approved_activities = your_campaign_rejected_activities;
            ...
            <div className="relative rounded-full w-10 h-10 border-[1px] border-icons-border bg-accent1">
                ...
                <div className="relative w-[48px] h-[48px]">
                  <Image
                    ...
                    alt="Profile Picture"
                    src={your_campaign_rejected_activities?.text?.actor_profile_picture_url}
                    fill
                  />
                </div>
              ...
              <div className="flex justify-between">
                <span className="mt-[10px] text-black text-[15px]">
                  <div className="hover:cursor-pointer flex gap-1 justify-between">
                    <p className="">
                   <span className="text-sm font-[400]">Oh no! Your Campaign </span><span className="text-lg text-primary-purple-500 font-[600] hover:underline">{your_campaign_rejected_activities?.text?.campaign_name}</span><span className="text-sm font-[400]"> got rejected</span><br/>
                   <span className="text-sm font-[400]">Don't worry, upload another campaign now.</span>
                    </p>
              ...
              <div className="flex gap-[24px] mt-[4%] w-full items-end">
                <div className="relative w-[100px] h-[100px] border-[1px] border-icons-border bg-accent1">
                      ...
                      <Image
                        ...
                        alt="Portfolio Cover"
                        src={your_campaign_rejected_activities?.text?.cover_image_url}
                        fill
                      />
                      l{" "}
